...
//        goto syntax projects.com
        ...
        //enter the password
        WebElement password = driver.findElement(By.id("ctl00_MainContent_login_button"));
        ...
        List<WebElement> column = driver.findElements(By.xpath("//tables[@class='SampleTable']/tbody/tr/td[3]"));
        ...
        for (int i=0; i<column.size();i++){
            ...
            if(text.equalsIgnoreCase("ScreenSaver")){
                ...
                System.out.println("the row that contains screensaver is  "+i);
